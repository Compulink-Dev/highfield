      ...
      <div className="container relative mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="inline-flex items-center rounded-full bg-blue-500/10 px-4 py-2 text-sm font-semibold text-blue-400 mb-6">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden border-2 border-blue-500/30 shadow-2xl">
              ...
              <div className="bg-gradient-to-b from-blue-600 to-blue-800 p-8 text-white">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    <h3 className="text-2xl font-bold">2-Week Truck Mastery</h3>
            ...
            <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-2xl p-4 border">
